...
import { BackgroundBandOptions, BackgroundBandPaneView } from '../views/pane/background-band-pane-view';
...
export class BackgroundBandDataSource extends PriceDataSource {
	private readonly _paneView: BackgroundBandPaneView;
	...
	public constructor(model: ChartModel, options: BackgroundBandOptions) {
		super(model);
		this._paneView = new BackgroundBandPaneView(model, options);
	}
