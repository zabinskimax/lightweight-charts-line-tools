...
import { OverlayBoxInternalOptions, OverlayBoxPaneView } from '../views/pane/overlay-box-pane-view';
...
export class OverlayBoxDataSource extends PriceDataSource {
	private readonly _paneView: OverlayBoxPaneView;
	...
	public constructor(model: ChartModel, series: Series, options: OverlayBoxInternalOptions) {
		super(model);
		this._paneView = new OverlayBoxPaneView(model, series, options);
	}
