...
import {
	BarColorOverlayInternalOptions,
	BarColorOverlayPaneView,
} from '../views/pane/bar-color-overlay-pane-view';
...
export class BarColorOverlayDataSource extends PriceDataSource {
	private readonly _paneView: BarColorOverlayPaneView;
	...
	public constructor(model: ChartModel, options: BarColorOverlayInternalOptions) {
		super(model);
		this._paneView = new BarColorOverlayPaneView(model, options);
	}
