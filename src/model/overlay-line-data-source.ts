...
import { OverlayLineInternalOptions, OverlayLinePaneView } from '../views/pane/overlay-line-pane-view';
...
export class OverlayLineDataSource extends PriceDataSource {
	private readonly _paneView: OverlayLinePaneView;
	...
	public constructor(model: ChartModel, series: Series, options: OverlayLineInternalOptions) {
		super(model);
		this._paneView = new OverlayLinePaneView(model, series, options);
	}
